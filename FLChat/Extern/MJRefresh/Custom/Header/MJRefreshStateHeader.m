...
- (UILabel *)stateLabel
{
    if (!_stateLabel) {
        ...
        _stateLabel.font = [UIFont fontWithName:@"Arial" size:13.0f];//Am6
    }
    return _stateLabel;
}
...
- (UILabel *)lastUpdatedTimeLabel
{
    if (!_lastUpdatedTimeLabel) {
        ...
        _lastUpdatedTimeLabel.font = [UIFont fontWithName:@"Arial" size:13.0f];//Am6
    }
...
//                                          time];
        self.lastUpdatedTimeLabel.text = [NSString stringWithFormat:@"%@%@",
                                          [NSBundle mj_localizedStringForKey:MJRefreshHeaderLastTimeText],time];
    } else {
        self.lastUpdatedTimeLabel.text = [NSString stringWithFormat:@"%@%@",
                                          [NSBundle mj_localizedStringForKey:MJRefreshHeaderLastTimeText],
